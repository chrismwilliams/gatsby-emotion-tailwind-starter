...
const HeroWrapper = styled.div`
  ${tw`px-2 lg:px-0 min-h-screen flex items-center justify-center lg:justify-start`};
...
const HeroTxt = styled.div`
  ${tw`lg:ml-10 -mt-16 lg:-mt-32 p-3 lg:p-8 inline-flex flex-col items-center lg:items-start text-white text-center lg:text-left bg-purple-800 rounded shadow-lg`};
  h1 {
