    ...
    <StyledHero>
      <div>
        <h1>
          ...
          I'm a static website template made with Gatsby
        </h1>
        <p>
          I include all modern features, like lazy-loading images and come
          pre-packed with Gatsby JS, Emotion, and Tailwind CSS. Now go build
          something cool!
        </p>
      </div>
      <span>
